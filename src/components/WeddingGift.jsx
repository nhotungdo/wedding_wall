...
const giftAccounts = [
  {
    ...
    accountName: 'DANG VAN MINH',
    qrImage: 'https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=VCB-999988886666-DANG+VAN+MINH'
  },
  {
    id: 'bride',
    type: 'NHÀ GÁI (PHƯƠNG)',
    ...
    accountName: 'NGUYEN THI PHUONG',
    qrImage: 'https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=TCB-888877775555-NGUYEN+THI+PHUONG'
  }
];
